...
namespace TimeTracker.View
{
    internal class InputManager
    {
        ...
        public string GetUserType()
        {
            ...
            .AddChoices(new[] {
                        $"{InitialMenu.OldUser}", $"{InitialMenu.NewUser}", $"{InitialMenu.ExitApplication}"
                    }));
        ...
        public string GetTaskStatus()
        {
            ...
            .AddChoices(new[] {
                    $"{UserTaskStatus.Created}", $"{UserTaskStatus.Started}", $"{UserTaskStatus.Paused}",$"{UserTaskStatus.Stopped}", "Skip"
                    }));
